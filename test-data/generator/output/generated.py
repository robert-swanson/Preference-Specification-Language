...
def scorePlan():
  ...
  if evaluator.contextStack.subcontext(lambda: (evaluator.courseName('COS 120') and (evaluator.courseName('COS 121') or evaluator.courseName('COS 143')))):
    ...
    print('Closing Scope')
  scorer.scoreSigmoid(evaluator.totalCreditsGreaterThanEqualToCourseNumber(200), 18.0, 'More than 80 credits over 200', worstBound=None, bestBound=None, lowerQuartile=80.0, upperQuartile=85.0)
